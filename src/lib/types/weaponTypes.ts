...
export const defaultDamageTypes: WeaponRecordPropertyDefinition<'defaultDamageType'> = {
...
export const equipmentSlotTypes: WeaponRecordPropertyDefinition<'equipmentSlotTypeHash'> = {
...
export const ammoTypes: WeaponRecordPropertyDefinition<'ammoType'> = {
...
export const itemCategories: WeaponRecordPropertyDefinition<'itemCategory'> = {
...
export const tierTypes: WeaponRecordPropertyDefinition<'tierTypeHash'> = {
...
export type WeaponRecordPropertyDefinition<T extends NonRecordWeaponLiteProperties> = {
	...
	propertyHashes: 'ammoType' extends T
